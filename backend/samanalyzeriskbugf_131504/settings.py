"""
Django settings for samanalyzeriskbugf_131504 project.
...
ROOT_URLCONF = 'samanalyzeriskbugf_131504.urls'
...
WSGI_APPLICATION = 'samanalyzeriskbugf_131504.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "samanalyzeriskbugf_131504 API",
    "DESCRIPTION": "API documentation for samanalyzeriskbugf_131504 App",
    "VERSION": "v1",
}
